...
main(int argc, char *argv[])
{
  ...
  53:	e8 8a 03 00 00       	callq  3e2 <unlink>
  ...
  76:	48 c7 c6 33 0b 00 00 	mov    $0xb33,%rsi
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ba:	0f b6 92 90 0d 00 00 	movzbl 0xd90(%rdx),%edx
 4c1:	48 98                	cltq   
...
printf(int fd, char *fmt, ...)
{
 ...
 75e:	75 31                	jne    791 <printf+0x276>
          s = "(null)";
 760:	48 c7 85 48 ff ff ff 	movq   $0xb4c,-0xb8(%rbp)
 767:	4c 0b 00 00 
        while(*s != 0){
...
free(void *ap)
{
 ...
 89a:	48 8b 05 1f 05 00 00 	mov    0x51f(%rip),%rax        # dc0 <freep>
 ...
 99e:	48 89 05 1b 04 00 00 	mov    %rax,0x41b(%rip)        # dc0 <freep>
}
 9a5:	90                   	nop
 9a6:	c9                   	leaveq 
 9a7:	c3                   	retq   
...
morecore(uint nu)
{
 ...
 9ff:	e8 7e fe ff ff       	callq  882 <free>
  return freep;
 a04:	48 8b 05 b5 03 00 00 	mov    0x3b5(%rip),%rax        # dc0 <freep>
}
 a0b:	c9                   	leaveq 
 a0c:	c3                   	retq   
...
malloc(uint nbytes)
{
 ...
 a26:	89 45 ec             	mov    %eax,-0x14(%rbp)
  if((prevp = freep) == 0){
 a29:	48 8b 05 90 03 00 00 	mov    0x390(%rip),%rax        # dc0 <freep>
 a30:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
 a34:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
 a39:	75 2b                	jne    a66 <malloc+0x59>
    base.s.ptr = freep = prevp = &base;
 a3b:	48 c7 45 f0 b0 0d 00 	movq   $0xdb0,-0x10(%rbp)
 a42:	00 
 a43:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
 a47:	48 89 05 72 03 00 00 	mov    %rax,0x372(%rip)        # dc0 <freep>
 a4e:	48 8b 05 6b 03 00 00 	mov    0x36b(%rip),%rax        # dc0 <freep>
 a55:	48 89 05 54 03 00 00 	mov    %rax,0x354(%rip)        # db0 <base>
    base.s.size = 0;
 a5c:	c7 05 52 03 00 00 00 	movl   $0x0,0x352(%rip)        # db8 <base+0x8>
 a63:	00 00 00 
  }
 ...
 acb:	48 89 05 ee 02 00 00 	mov    %rax,0x2ee(%rip)        # dc0 <freep>
      return (void*)(p + 1);
 ...
 ada:	eb 41                	jmp    b1d <malloc+0x110>
    ...
    if(p == freep)
 adc:	48 8b 05 dd 02 00 00 	mov    0x2dd(%rip),%rax        # dc0 <freep>
